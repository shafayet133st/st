...
@section('content')
 <div class="content-wrapper">
    ...
    <div class="card">
      <div class="card-header text-center text-info display-4"> District  Edit</div>
      <div class="card-body">
        <form action="{{ route('admin.update',$District->id)}}" method="post" enctype="multipart/form-data">
          @csrf
          @include('admin.page.e')
  <div class="form-group">
    <label for="District Name">District Name</label>
    <input type="text" class="form-control" name="name" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{$District->name}}">
  </div>
  <div class="form-group">
